/*** Generated by Spin Version 6.3.2 -- 17 May 2014 ***/
/*** From source: producers_consumers.pml ***/
...
short src_ln1 [] = {
	  0,  22,  23,  24,  25,  20,  27,  20, 
	 27,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "./producers_consumers.pml", 1, 8 },
	{ "-", 9, 10 }
};
uchar reached1 [] = {
	  0,   1,   0,   0,   0,   0,   1,   1, 
...
inirand(void)
{	int i;
	srand(123+HASH_NR);	/* fixed startpoint */
